      ...
      <div className="mt-12 lg:my-28">
        ...
        <div className="relative">
          <div className="custombg">
            <div className="mx-10">
              <div className="mt-20 max-w-6xl mx-auto bg-white drop-shadow-xl h-full rounded-t-md py-12 px-4 lg:px-0">
              ...
              <div className="max-w-6xl mx-auto bg-white drop-shadow-xl h-full rounded-b-md border-t py-12 px-5 lg:px-0">
